...
date: 2026-04-19
status: PR A complete 2026-04-21 under [Unreleased]. PR B partial: 5 of 7 recipes shipped 2026-04-22 (multi-namespace-events, bridge-vlan, bidirectional-rate-limit, wireguard-mesh, nftables-stateful-fw) + recipe index + README/CLAUDE.md pointers. Deferred: xfrm-ipsec-tunnel (XFRM connection is dump-only — needs a Plan-137-shaped library extension before a real recipe is possible); cgroup-classification remains blocked on Plan 133 PR C.
---
