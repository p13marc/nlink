...
//    (When driving the declarative `WireguardConfig` instead,
//    `cfg.ensure_devices(&route)` creates any declared-but-absent
//    links idempotently and brings every declared link up — #169,
//    #329 — so both lines of this manual step disappear.)
