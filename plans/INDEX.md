...
| [175](175-release-cut-tooling-plan.md) | `scripts/cut-release.sh` orchestrating the cut sequence + handling the `cargo publish --dry-run` inversion, CHANGELOG promotion, GitHub release length truncation | ~2 h | 6 | 🟡 | #4 | Script landed locally; will get its real shakedown at the 0.17 cut. |
