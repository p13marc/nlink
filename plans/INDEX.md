...
| [153](153-0.16-kernel-feature-bundle-plan.md) | XFRM IPsec offload (`XFRMA_OFFLOAD_DEV`) + Devlink rate + port-function-state + TX H/W shaping (`net_shaper` GENL) | ~5 days | 5 | 🟡 | – | §4.1 XFRM offload + §4.2 Devlink rate / port-function-state landed. **§4.3 net_shaper GENL family blocked on Plan 154 Phase 8** — needs the same GenlEnum/bitflags/nested-group field-type support that Plan 156 needs |
