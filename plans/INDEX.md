...
| [156](156-0.16-dpll-genl-family-plan.md) | DPLL netlink family (kernel 6.7+) — first in-tree user of `nlink-macros`. ~130 lines of macro-derived declaration for the full family | ~2 days | 10 | ⚪ | – | Validates Plan 154's design end-to-end; telco SyncE/PTP use case. **Fully unblocked** — every DPLL field shape (scalar enums, repeated enums, bitflags, signed ints, nested attribute groups) now expressible via the macros after Plan 154 Phase 8 completion. Ready to start |
